...
RowReducedWindow::RowReducedWindow(MatrixLibrary* lib, QWidget* parent) : QWidget (parent)
{
    ...
    QLabel* title = new QLabel("Echelonnage");
    ...
    connect(calculer, &QPushButton::clicked, this, &RowReducedWindow::computeOperation);

    setLayout(mainLayout);
}


void RowReducedWindow:: computeSelection ()
{
    int selectedRow;
...
void RowReducedWindow:: computeOperation ()
{
    if(op1 == nullptr)
    {
